...
其中
\begin{equation}
	\mathbf a'\!\left(0\right):=\left[\begin{matrix}0\\0\\l\end{matrix}\right].
\end{equation}
是 A 的初始坐标.
...
定义电容矩阵
\begin{equation}
	\mathbf C:=\left[\begin{matrix}\frac1{C_1}&\frac1N\\
	\frac1N&\frac1{C_2}\end{matrix}\right]^{-1},
\end{equation}
电感矩阵
\begin{equation}
	\mathbf L:=\left[\begin{matrix}L_1&M\\M&L_2\end{matrix}\right],
\end{equation}
...
其中
\begin{gather}
	p:=\frac MN-\frac12\left(\frac{L_1}{C_2}+\frac{L_2}{C_1}\right),\\
	\Delta:=\frac{L_1L_2}{N^2}+\frac{M^2}{C_1C_2}+\frac14\left(\frac{L_1}{C_2}-\frac{L_2}{C_1}\right)^2-\left(\frac{L_1}{C_2}+\frac{L_2}{C_1}\right)\frac MN.
\end{gather}
