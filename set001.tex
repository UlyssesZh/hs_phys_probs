...
\renewcommand\thesubsection{\setcounter{para}{0}第 \arabic{subsection} 题}
...
将 $4$ 个相同的刚性的轻质的内角为 $\frac{2\pi}3$ 的等边球面三角形拼成一个半径为 $R$ 的球面,
然后将球内抽成真空, 放置在具有压强 $p$ 的大气中.
